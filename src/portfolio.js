...
const degrees = {
  degrees: [
    {
      title: "University Department, Rajasthan Technical University",
      ...
      website_link: "http://www.rtu.ac.in/",
    },
  ],
};
  ...
  sections: [
    {
      ...
      experiences: [
        {
          title: "Web Developer and Mentor",
          company: "Techknights, RTU, Kota",
          company_url: "https://",
          logo_path: "techknights.png",
          duration: "Oct 2018 - Present",
          location: "college",
          description:
            "I worked as a Frontend web developer and mentored some college juniors for the learning the web development",
          color: "#0071C5",
        },
        // {
...
const contactPageData = {
  contactSection: {
    ...
    description:
      "You can hit me up anytime at my social media handles. I will try to get back to you as fast as I can. ",
  },
  blogSection: {
    title: "Blogs",
    subtitle:
...
const projects = {
  data: [
    {
      id: "0",
      name: "Movie-Series Searching",
      url: "https://github.com/devbysn/movie-series-searching-app",
      description:
        "This is a simple web app which helps you find movies and web series and also show Trending feed",
      languages: [
        {
          name: "HTML5",
    ...
    },
    {
      id: "1",
      name: "2048 Game",
      url: "https://github.com/Micro-Processing-Minions/2048-game-app",
